...
func (s *store) GetByID(id int) (*models.Product, error) {
...
func (s *store) Create(product *models.Product) (*models.Product, error) {
...
func (s *store) Update(id int, product *models.Product) (*models.Product, error) {
